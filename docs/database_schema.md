...
| `0061_licence_plans.sql` | 3 balíčky `licence_plans` (carpeta / despacho / asesoria) + `licence_plan_modules`; `tenant_settings.licence_plan_key`; RPC `set_office_plan` / `set_plan_monthly_cents`; doplňky AI a faktury |
